...
import config, { getConfig } from 'DeepWheels/GrafanaServer/public/app/core/config';
import { transformDataToTable } from './transformers';
import { tablePanelEditor } from './editor';
import { columnOptionsTab } from './column_options';
import { TableRenderer } from './renderer';
import { isTableData, PanelEvents, PanelPlugin } from '@grafana/data';
import { dispatch } from 'DeepWheels/GrafanaServer/public/app/store/store';
import { ComponentType } from 'react';
import { PanelProps } from '@grafana/data';
import { applyFilterFromTable } from 'DeepWheels/GrafanaServer/public/app/features/variables/adhoc/actions';
